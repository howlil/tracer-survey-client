          ...
          <CardContent>
            <div className='text-center py-12'>
              ...
              <p className='text-muted-foreground mb-4'>
                Halaman untuk melihat rekap dan laporan User Survey akan segera hadir.
              </p>
              <div className='text-sm text-muted-foreground'>
                <p>Fitur yang akan tersedia:</p>
                <ul className='mt-2 space-y-1'>
                  <li>• Dashboard statistik User Survey</li>
                  <li>• Grafik tingkat kepuasan</li>
                  <li>• Analisis berdasarkan kategori</li>
                  <li>• Export data ke Excel/PDF</li>
                  <li>• Filter berdasarkan periode</li>
                  <li>• Perbandingan hasil survey</li>
                </ul>
              </div>
            </div>
          </CardContent>
