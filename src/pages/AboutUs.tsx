            ...
            <div className='grid lg:grid-cols-2 gap-12 items-center mb-16'>
              <div className='space-y-6'>
                ...
                <p className='text-lg text-muted-foreground leading-relaxed'>
                  Sebagai bagian dari Universitas Andalas, kami berkomitmen
                  untuk mendukung program Merdeka Belajar Kemendikbudristek
                  melalui pengumpulan data tracer study dan survei pengguna yang
                  komprehensif.
                </p>
                <p className='text-muted-foreground leading-relaxed'>
                  Kami percaya bahwa data yang akurat dan terpercaya adalah
                  kunci untuk meningkatkan kualitas pendidikan dan layanan di
                  perguruan tinggi. Melalui platform ini, kami memfasilitasi
                  pengumpulan data yang efisien dan terstruktur.
                </p>
                <Button
              ...
              <div className='grid md:grid-cols-3 gap-8'>
                <div className='text-center space-y-4'>
                  ...
                  <p className='text-muted-foreground'>
                    Kami menjaga kejujuran dan transparansi dalam setiap proses
                ...
                <div className='text-center space-y-4'>
                  ...
                  <p className='text-muted-foreground'>
                    Kami berkomitmen untuk menghasilkan data berkualitas tinggi
                ...
                <div className='text-center space-y-4'>
                  ...
                  <p className='text-muted-foreground'>
                    Kami terus berinovasi dalam metode dan teknologi untuk
                    meningkatkan efektivitas pengumpulan data
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className='bg-primary/5 border border-primary/20 rounded-2xl p-8'>
              <div className='text-center space-y-6'>
                ...
                <p className='text-muted-foreground'>
                  ...
                  terkait tracer study dan survei
                </p>
