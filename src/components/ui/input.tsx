  ...
  return (
    <input
      ...
      className={cn(
        ...
        variant === "default" &&
          "rounded-md border border-input shadow-xs focus-visible:border-blue-500 focus-visible:ring-blue-500/20 focus-visible:ring-[2px]",
        variant === "underline" &&
          "rounded-none border-x-0 border-t-0 border-b border-gray-400 shadow-none focus-visible:ring-0 focus:border-b-2 focus:border-blue-500",
        className
      )}
      {...props}
    />
