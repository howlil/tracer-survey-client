    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center relative">
          ...
          <div className="hidden md:flex items-center space-x-12 absolute left-1/2 transform -translate-x-1/2">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-2 w-80 bg-popover border rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="p-2 space-y-2">
                  <button className="block w-full text-left p-2 rounded-md hover:bg-primary/10 transition-colors">
            ...
            <button className="text-sm font-medium text-foreground hover:text-primary transition-colors relative group pb-1">
              FAQ
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></span>
            </button>
          </div>
          ...
          <div className="hidden md:flex items-center ml-auto">
            <button className="text-sm font-medium text-primary hover:text-white hover:bg-primary/80 transition-colors px-4 py-2 rounded-md">
              About Us
            </button>
          </div>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-full right-4 z-50 mt-2">
          <div className="bg-background border rounded-lg shadow-lg py-2 min-w-[100px]">
            <button
              onClick={onHome}
            ...
            <button className="block w-full text-left px-4 py-2 text-sm font-medium text-foreground hover:bg-primary/10 hover:text-primary transition-colors">
              Tracer Study
            </button>
